                ...
                <div className="px-8 pb-8">
                    ...
                    <div className="relative -mt-16 mb-6">
                        <label htmlFor={isEdit ? "image-upload" : ""} className={isEdit ? "cursor-pointer" : ""}>
                            ...
                            />
                            {isEdit && (
                                <div className="absolute bottom-1 right-1 bg-blue-600 text-white text-xs rounded-full w-7 h-7 flex items-center justify-center shadow">
                                    ✏️
                                </div>
                            )}
                        </label>
                        ...
                        <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center">
                                ...
                                {isEdit
                                    ...
                                    // ✅ fallback text if gender not set
                                    : <p className="text-gray-700 font-medium">{userData.gender || "Not Selected"}</p>
                                }
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center">
                                ...
                                {isEdit
                                    ...
                                    />
                                    : <p className="text-gray-700 font-medium">{userData.dob || "Not Set"}</p>
                                }
                            </div>
                    ...
                    <div className="flex justify-center gap-4 mt-8">
                        {isEdit
                            ? <>
                                ...
                                <button
                                    className="bg-white border-2 border-gray-300 text-gray-600 font-semibold px-8 py-3 rounded-xl hover:bg-gray-100 transform hover:scale-105 transition-all duration-200 shadow-md"
